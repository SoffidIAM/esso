...
src/main/native/%.o: ../src/main/native/%.cpp
	...
	i586-mingw32msvc-g++ -DWIN32 -DXP_WIN=1 -DFF_VERSION=5 -I"/home/u07286/src/mazlin/AfroditaF/src/main/include" -I"/home/u07286/src/mazlin/AfroditaF/src/main/include-deps/gcc" -O0 -g3 -Wall -c -fmessage-length=0 -fshort-wchar -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
