/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /home/u07286/src/firefox/mozilla-release/dom/interfaces/core/nsIDOMDocument.idl
 */
...
#define NS_IDOMDOCUMENT_IID_STR "3e7421c4-9964-4184-8c75-d291eecdba35"

#define NS_IDOMDOCUMENT_IID \
  {0x3e7421c4, 0x9964, 0x4184, \
    { 0x8c, 0x75, 0xd2, 0x91, 0xee, 0xcd, 0xba, 0x35 }}
...
/* attribute boolean strictErrorChecking; */
NS_IMETHODIMP nsDOMDocument::GetStrictErrorChecking(PRBool *aStrictErrorChecking)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
NS_IMETHODIMP nsDOMDocument::SetStrictErrorChecking(PRBool aStrictErrorChecking)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* readonly attribute nsIDOMDOMConfiguration domConfig; */
NS_IMETHODIMP nsDOMDocument::GetDomConfig(nsIDOMDOMConfiguration **aDomConfig)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* nsIDOMNode renameNode (in nsIDOMNode node, in DOMString namespaceURI, in DOMString qualifiedName)  raises (DOMException); */
NS_IMETHODIMP nsDOMDocument::RenameNode(nsIDOMNode *node, const nsAString & namespaceURI, const nsAString & qualifiedName, nsIDOMNode **_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
