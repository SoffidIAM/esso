/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM c:/dev/mozilla/mozilla/content/base/public/nsISelection.idl
 */
...
class NS_NO_VTABLE nsISelection : public nsISupports {
 public: 
  ...
  NS_IMETHOD ContainsNode(nsIDOMNode *node, PRBool partlyContained, PRBool *_retval) = 0;
...
#define NS_DECL_NSISELECTION \
  ...
  NS_IMETHOD ContainsNode(nsIDOMNode *node, PRBool partlyContained, PRBool *_retval); \
...
#define NS_FORWARD_NSISELECTION(_to) \
  ...
  NS_IMETHOD ContainsNode(nsIDOMNode *node, PRBool partlyContained, PRBool *_retval) { return _to ContainsNode(node, partlyContained, _retval); } \
...
#define NS_FORWARD_SAFE_NSISELECTION(_to) \
  ...
  NS_IMETHOD ContainsNode(nsIDOMNode *node, PRBool partlyContained, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->ContainsNode(node, partlyContained, _retval); } \
