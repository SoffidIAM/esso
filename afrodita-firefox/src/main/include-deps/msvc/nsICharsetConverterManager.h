/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-192-xr-w32-bld/build/intl/uconv/idl/nsICharsetConverterManager.idl
 */
...
/* starting interface:    nsICharsetConverterManager_1_9_BRANCH */
#define NS_ICHARSETCONVERTERMANAGER_1_9_BRANCH_IID_STR "36982132-707c-4d77-b27f-958e76e022de"

#define NS_ICHARSETCONVERTERMANAGER_1_9_BRANCH_IID \
  {0x36982132, 0x707c, 0x4d77, \
    { 0xb2, 0x7f, 0x95, 0x8e, 0x76, 0xe0, 0x22, 0xde }}

class NS_NO_VTABLE NS_SCRIPTABLE nsICharsetConverterManager_1_9_BRANCH : public nsICharsetConverterManager {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_ICHARSETCONVERTERMANAGER_1_9_BRANCH_IID)
  ...
  NS_SCRIPTABLE NS_IMETHOD GetUnicodeDecoderInternal(const char *charset, nsIUnicodeDecoder **_retval NS_OUTPARAM) = 0;

  /* nsIUnicodeDecoder getUnicodeDecoderRawInternal (in string charset); */
  NS_SCRIPTABLE NS_IMETHOD GetUnicodeDecoderRawInternal(const char *charset, nsIUnicodeDecoder **_retval NS_OUTPARAM) = 0;

};

  NS_DEFINE_STATIC_IID_ACCESSOR(nsICharsetConverterManager_1_9_BRANCH, NS_ICHARSETCONVERTERMANAGER_1_9_BRANCH_IID)

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSICHARSETCONVERTERMANAGER_1_9_BRANCH \
  NS_SCRIPTABLE NS_IMETHOD GetUnicodeDecoderInternal(const char *charset, nsIUnicodeDecoder **_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD GetUnicodeDecoderRawInternal(const char *charset, nsIUnicodeDecoder **_retval NS_OUTPARAM); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSICHARSETCONVERTERMANAGER_1_9_BRANCH(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetUnicodeDecoderInternal(const char *charset, nsIUnicodeDecoder **_retval NS_OUTPARAM) { return _to GetUnicodeDecoderInternal(charset, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetUnicodeDecoderRawInternal(const char *charset, nsIUnicodeDecoder **_retval NS_OUTPARAM) { return _to GetUnicodeDecoderRawInternal(charset, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSICHARSETCONVERTERMANAGER_1_9_BRANCH(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetUnicodeDecoderInternal(const char *charset, nsIUnicodeDecoder **_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetUnicodeDecoderInternal(charset, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetUnicodeDecoderRawInternal(const char *charset, nsIUnicodeDecoder **_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetUnicodeDecoderRawInternal(charset, _retval); } 

#if 0
/* Use the code below as a template for the implementation class for this interface. */

/* Header file */
class nsCharsetConverterManager_1_9_BRANCH : public nsICharsetConverterManager_1_9_BRANCH
{
public:
  NS_DECL_ISUPPORTS
  NS_DECL_NSICHARSETCONVERTERMANAGER_1_9_BRANCH

  nsCharsetConverterManager_1_9_BRANCH();
...
/* Implementation file */
NS_IMPL_ISUPPORTS1(nsCharsetConverterManager_1_9_BRANCH, nsICharsetConverterManager_1_9_BRANCH)

nsCharsetConverterManager_1_9_BRANCH::nsCharsetConverterManager_1_9_BRANCH()
{
  /* member initializers and constructor code */
}
...
/* nsIUnicodeDecoder getUnicodeDecoderInternal (in string charset); */
NS_IMETHODIMP nsCharsetConverterManager_1_9_BRANCH::GetUnicodeDecoderInternal(const char *charset, nsIUnicodeDecoder **_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* nsIUnicodeDecoder getUnicodeDecoderRawInternal (in string charset); */
NS_IMETHODIMP nsCharsetConverterManager_1_9_BRANCH::GetUnicodeDecoderRawInternal(const char *charset, nsIUnicodeDecoder **_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
