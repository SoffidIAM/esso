/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-192-xr-w32-bld/build/toolkit/mozapps/update/public/nsIUpdateService.idl
 */
...
/* starting interface:    nsIApplicationUpdateService2 */
#define NS_IAPPLICATIONUPDATESERVICE2_IID_STR "e22e4bf1-b18c-40cd-a2be-2d565723d056"

#define NS_IAPPLICATIONUPDATESERVICE2_IID \
  {0xe22e4bf1, 0xb18c, 0x40cd, \
    { 0xa2, 0xbe, 0x2d, 0x56, 0x57, 0x23, 0xd0, 0x56 }}
 ...
 * removed.
 */
class NS_NO_VTABLE NS_SCRIPTABLE nsIApplicationUpdateService2 : public nsIApplicationUpdateService {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_IAPPLICATIONUPDATESERVICE2_IID)
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(nsIApplicationUpdateService2, NS_IAPPLICATIONUPDATESERVICE2_IID)

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIAPPLICATIONUPDATESERVICE2 \
...
/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIAPPLICATIONUPDATESERVICE2(_to) \
...
/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIAPPLICATIONUPDATESERVICE2(_to) \
...
/* Header file */
class nsApplicationUpdateService2 : public nsIApplicationUpdateService2
{
public:
  NS_DECL_ISUPPORTS
  NS_DECL_NSIAPPLICATIONUPDATESERVICE2

  nsApplicationUpdateService2();
...
/* Implementation file */
NS_IMPL_ISUPPORTS1(nsApplicationUpdateService2, nsIApplicationUpdateService2)

nsApplicationUpdateService2::nsApplicationUpdateService2()
{
  /* member initializers and constructor code */
}
...
/* readonly attribute boolean canCheckForUpdates; */
NS_IMETHODIMP nsApplicationUpdateService2::GetCanCheckForUpdates(PRBool *aCanCheckForUpdates)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* readonly attribute boolean canApplyUpdates; */
NS_IMETHODIMP nsApplicationUpdateService2::GetCanApplyUpdates(PRBool *aCanApplyUpdates)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
