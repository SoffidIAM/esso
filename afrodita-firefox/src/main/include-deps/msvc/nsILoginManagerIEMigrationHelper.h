/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-192-xr-w32-bld/build/toolkit/components/passwordmgr/public/nsILoginManagerIEMigrationHelper.idl
 */
