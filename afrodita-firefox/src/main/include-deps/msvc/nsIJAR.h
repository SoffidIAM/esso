/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-192-xr-w32-bld/build/modules/libjar/nsIJAR.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIJAR : public nsISupports {
 public: 
...
/* nsIPrincipal getCertificatePrincipal (in string aEntryName); */
NS_IMETHODIMP nsJAR::GetCertificatePrincipal(const char *aEntryName, nsIPrincipal **_retval NS_OUTPARAM)
{
