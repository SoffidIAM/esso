/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-192-xr-w32-bld/build/content/events/public/nsIEventListenerService.idl
 */
...
#define NS_IEVENTLISTENERSERVICE_IID_STR "551cac0f-31ed-45e0-8d67-bc0d6e117b31"

#define NS_IEVENTLISTENERSERVICE_IID \
  {0x551cac0f, 0x31ed, 0x45e0, \
    { 0x8d, 0x67, 0xbc, 0x0d, 0x6e, 0x11, 0x7b, 0x31 }}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIEventListenerService : public nsISupports {
 public: 
   ...
   */
  /* void getListenerInfoFor (in nsIDOMEventTarget aEventTarget, out unsigned long aCount, [array, size_is (aCount), retval] out nsIEventListenerInfo aOutArray); */
  ...
  */
  /* void getEventTargetChainFor (in nsIDOMEventTarget aEventTarget, out unsigned long aCount, [array, size_is (aCount), retval] out nsIDOMEventTarget aOutArray); */
