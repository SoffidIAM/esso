/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-192-xr-w32-bld/build/content/html/content/public/nsISelectElement.idl
 */
...
class NS_NO_VTABLE nsISelectElement : public nsISupports {
 public: 
  ...
  NS_IMETHOD IsOptionDisabled(PRInt32 aIndex, PRBool *_retval NS_OUTPARAM) = 0;
  ...
  NS_IMETHOD SetOptionsSelectedByIndex(PRInt32 aStartIndex, PRInt32 aEndIndex, PRBool aIsSelected, PRBool aClearAll, PRBool aSetDisabled, PRBool aNotify, PRBool *_retval NS_OUTPARAM) = 0;
  ...
  NS_IMETHOD GetOptionIndex(nsIDOMHTMLOptionElement *aOption, PRInt32 aStartIndex, PRBool aForward, PRInt32 *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSISELECTELEMENT \
  ...
  NS_IMETHOD IsOptionDisabled(PRInt32 aIndex, PRBool *_retval NS_OUTPARAM); \
  NS_IMETHOD SetOptionsSelectedByIndex(PRInt32 aStartIndex, PRInt32 aEndIndex, PRBool aIsSelected, PRBool aClearAll, PRBool aSetDisabled, PRBool aNotify, PRBool *_retval NS_OUTPARAM); \
  NS_IMETHOD GetOptionIndex(nsIDOMHTMLOptionElement *aOption, PRInt32 aStartIndex, PRBool aForward, PRInt32 *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSISELECTELEMENT(_to) \
  ...
  NS_IMETHOD IsOptionDisabled(PRInt32 aIndex, PRBool *_retval NS_OUTPARAM) { return _to IsOptionDisabled(aIndex, _retval); } \
  NS_IMETHOD SetOptionsSelectedByIndex(PRInt32 aStartIndex, PRInt32 aEndIndex, PRBool aIsSelected, PRBool aClearAll, PRBool aSetDisabled, PRBool aNotify, PRBool *_retval NS_OUTPARAM) { return _to SetOptionsSelectedByIndex(aStartIndex, aEndIndex, aIsSelected, aClearAll, aSetDisabled, aNotify, _retval); } \
  NS_IMETHOD GetOptionIndex(nsIDOMHTMLOptionElement *aOption, PRInt32 aStartIndex, PRBool aForward, PRInt32 *_retval NS_OUTPARAM) { return _to GetOptionIndex(aOption, aStartIndex, aForward, _retval); } \
...
#define NS_FORWARD_SAFE_NSISELECTELEMENT(_to) \
  ...
  NS_IMETHOD IsOptionDisabled(PRInt32 aIndex, PRBool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsOptionDisabled(aIndex, _retval); } \
  ...
  NS_IMETHOD GetOptionIndex(nsIDOMHTMLOptionElement *aOption, PRInt32 aStartIndex, PRBool aForward, PRInt32 *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetOptionIndex(aOption, aStartIndex, aForward, _retval); } \
