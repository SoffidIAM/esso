/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-192-xr-w32-bld/build/toolkit/components/places/public/nsPIPlacesHistoryListenersNotifier.idl
 */
