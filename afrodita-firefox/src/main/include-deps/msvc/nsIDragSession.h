/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-192-xr-w32-bld/build/widget/public/nsIDragSession.idl
 */
...
/* starting interface:    nsIDragSession_1_9_2 */
#define NS_IDRAGSESSION_1_9_2_IID_STR "fde41f6a-c710-46f8-a0a8-1ff76ca4ff57"

#define NS_IDRAGSESSION_1_9_2_IID \
  {0xfde41f6a, 0xc710, 0x46f8, \
    { 0xa0, 0xa8, 0x1f, 0xf7, 0x6c, 0xa4, 0xff, 0x57 }}

class NS_NO_VTABLE NS_SCRIPTABLE nsIDragSession_1_9_2 : public nsISupports {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_IDRAGSESSION_1_9_2_IID)
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(nsIDragSession_1_9_2, NS_IDRAGSESSION_1_9_2_IID)

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIDRAGSESSION_1_9_2 \
...
/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDRAGSESSION_1_9_2(_to) \
...
/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDRAGSESSION_1_9_2(_to) \
...
/* Header file */
class nsDragSession_1_9_2 : public nsIDragSession_1_9_2
{
public:
  NS_DECL_ISUPPORTS
...
/* Implementation file */
NS_IMPL_ISUPPORTS1(nsDragSession_1_9_2, nsIDragSession_1_9_2)

nsDragSession_1_9_2::nsDragSession_1_9_2()
{
  /* member initializers and constructor code */
}
...
/* attribute boolean onlyChromeDrop; */
NS_IMETHODIMP nsDragSession_1_9_2::GetOnlyChromeDrop(PRBool *aOnlyChromeDrop)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
NS_IMETHODIMP nsDragSession_1_9_2::SetOnlyChromeDrop(PRBool aOnlyChromeDrop)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
