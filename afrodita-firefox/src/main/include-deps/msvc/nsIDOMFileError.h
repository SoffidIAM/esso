/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-192-xr-w32-bld/build/content/base/public/nsIDOMFileError.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMFileError : public nsISupports {
 public: 
  ...
  enum { NOT_READABLE_ERR = 24U };

  enum { SECURITY_ERR = 18U };

  enum { ABORT_ERR = 20U };

  enum { ENCODING_ERR = 26U };
