/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-192-xr-w32-bld/build/docshell/base/nsIDocShell.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDocShell : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetSessionStorageForURI(nsIURI *uri, nsIDOMStorage **_retval NS_OUTPARAM) = 0;

  /* nsIDOMStorage getSessionStorageForPrincipal (in nsIPrincipal principal, in boolean create); */
  NS_SCRIPTABLE NS_IMETHOD GetSessionStorageForPrincipal(nsIPrincipal *principal, PRBool create, nsIDOMStorage **_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIDOCSHELL \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetSessionStorageForURI(nsIURI *uri, nsIDOMStorage **_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD GetSessionStorageForPrincipal(nsIPrincipal *principal, PRBool create, nsIDOMStorage **_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIDOCSHELL(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetSessionStorageForURI(nsIURI *uri, nsIDOMStorage **_retval NS_OUTPARAM) { return _to GetSessionStorageForURI(uri, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetSessionStorageForPrincipal(nsIPrincipal *principal, PRBool create, nsIDOMStorage **_retval NS_OUTPARAM) { return _to GetSessionStorageForPrincipal(principal, create, _retval); } \
...
#define NS_FORWARD_SAFE_NSIDOCSHELL(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetSessionStorageForURI(nsIURI *uri, nsIDOMStorage **_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetSessionStorageForURI(uri, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetSessionStorageForPrincipal(nsIPrincipal *principal, PRBool create, nsIDOMStorage **_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetSessionStorageForPrincipal(principal, create, _retval); } \
...
/* nsIDOMStorage getSessionStorageForPrincipal (in nsIPrincipal principal, in boolean create); */
NS_IMETHODIMP nsDocShell::GetSessionStorageForPrincipal(nsIPrincipal *principal, PRBool create, nsIDOMStorage **_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
