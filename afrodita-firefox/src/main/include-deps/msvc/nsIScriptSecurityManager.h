/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-192-xr-w32-bld/build/caps/idl/nsIScriptSecurityManager.idl
 */
...
/* starting interface:    nsIScriptSecurityManager_1_9_2 */
#define NS_ISCRIPTSECURITYMANAGER_1_9_2_IID_STR "8229dd23-47c5-4601-a80b-0166d595a21e"

#define NS_ISCRIPTSECURITYMANAGER_1_9_2_IID \
  {0x8229dd23, 0x47c5, 0x4601, \
    { 0xa8, 0x0b, 0x01, 0x66, 0xd5, 0x95, 0xa2, 0x1e }}

class NS_NO_VTABLE NS_SCRIPTABLE nsIScriptSecurityManager_1_9_2 : public nsIScriptSecurityManager {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_ISCRIPTSECURITYMANAGER_1_9_2_IID)
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(nsIScriptSecurityManager_1_9_2, NS_ISCRIPTSECURITYMANAGER_1_9_2_IID)

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSISCRIPTSECURITYMANAGER_1_9_2 \
...
/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSISCRIPTSECURITYMANAGER_1_9_2(_to) \
...
/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSISCRIPTSECURITYMANAGER_1_9_2(_to) \
...
/* Header file */
class nsScriptSecurityManager_1_9_2 : public nsIScriptSecurityManager_1_9_2
{
public:
  NS_DECL_ISUPPORTS
  NS_DECL_NSISCRIPTSECURITYMANAGER_1_9_2

  nsScriptSecurityManager_1_9_2();
...
/* Implementation file */
NS_IMPL_ISUPPORTS1(nsScriptSecurityManager_1_9_2, nsIScriptSecurityManager_1_9_2)

nsScriptSecurityManager_1_9_2::nsScriptSecurityManager_1_9_2()
{
  /* member initializers and constructor code */
}
...
/* [noscript] void pushContextPrincipal (in JSContextPtr cx, in JSStackFramePtr fp, in nsIPrincipal principal); */
NS_IMETHODIMP nsScriptSecurityManager_1_9_2::PushContextPrincipal(JSContext * cx, JSStackFrame * fp, nsIPrincipal *principal)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* [noscript] void popContextPrincipal (in JSContextPtr cx); */
NS_IMETHODIMP nsScriptSecurityManager_1_9_2::PopContextPrincipal(JSContext * cx)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
