/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-192-xr-w32-bld/build/js/jsd/idl/jsdIDebuggerService.idl
 */
...
/**
  ...
  NS_IMETHOD WrapJSValue(jsval value, jsdIValue **_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_JSDIDEBUGGERSERVICE \
  ...
  NS_IMETHOD WrapJSValue(jsval value, jsdIValue **_retval NS_OUTPARAM); \
...
#define NS_FORWARD_JSDIDEBUGGERSERVICE(_to) \
  ...
  NS_IMETHOD WrapJSValue(jsval value, jsdIValue **_retval NS_OUTPARAM) { return _to WrapJSValue(value, _retval); } \
...
#define NS_FORWARD_SAFE_JSDIDEBUGGERSERVICE(_to) \
  ...
  NS_IMETHOD WrapJSValue(jsval value, jsdIValue **_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->WrapJSValue(value, _retval); } \
...
/* [noscript] jsdIValue wrapJSValue (in JSVal value); */
NS_IMETHODIMP _MYCLASS_::WrapJSValue(jsval value, jsdIValue **_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
