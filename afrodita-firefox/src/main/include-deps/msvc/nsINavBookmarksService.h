/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-192-xr-w32-bld/build/toolkit/components/places/public/nsINavBookmarksService.idl
 */
...
#define NS_INAVBOOKMARKOBSERVER_IID_STR "1f7e9032-b2c0-4561-b35b-94ba3f8344e2"

#define NS_INAVBOOKMARKOBSERVER_IID \
  {0x1f7e9032, 0xb2c0, 0x4561, \
    { 0xb3, 0x5b, 0x94, 0xba, 0x3f, 0x83, 0x44, 0xe2 }}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsINavBookmarkObserver : public nsISupports {
 public: 
   ...
   *        defined above).
   */
  /* void onItemAdded (in long long aItemId, in long long aParentId, in long aIndex, in unsigned short aItemType); */
  NS_SCRIPTABLE NS_IMETHOD OnItemAdded(PRInt64 aItemId, PRInt64 aParentId, PRInt32 aIndex, PRUint16 aItemType) = 0;
...
#define NS_DECL_NSINAVBOOKMARKOBSERVER \
  ...
  NS_SCRIPTABLE NS_IMETHOD OnItemAdded(PRInt64 aItemId, PRInt64 aParentId, PRInt32 aIndex, PRUint16 aItemType); \
...
#define NS_FORWARD_NSINAVBOOKMARKOBSERVER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD OnItemAdded(PRInt64 aItemId, PRInt64 aParentId, PRInt32 aIndex, PRUint16 aItemType) { return _to OnItemAdded(aItemId, aParentId, aIndex, aItemType); } \
...
#define NS_FORWARD_SAFE_NSINAVBOOKMARKOBSERVER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD OnItemAdded(PRInt64 aItemId, PRInt64 aParentId, PRInt32 aIndex, PRUint16 aItemType) { return !_to ? NS_ERROR_NULL_POINTER : _to->OnItemAdded(aItemId, aParentId, aIndex, aItemType); } \
...
/* void onItemAdded (in long long aItemId, in long long aParentId, in long aIndex, in unsigned short aItemType); */
NS_IMETHODIMP nsNavBookmarkObserver::OnItemAdded(PRInt64 aItemId, PRInt64 aParentId, PRInt32 aIndex, PRUint16 aItemType)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
