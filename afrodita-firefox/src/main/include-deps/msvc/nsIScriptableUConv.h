/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-192-xr-w32-bld/build/intl/uconv/idl/nsIScriptableUConv.idl
 */
...
/* starting interface:    nsIScriptableUnicodeConverter_1_9_BRANCH */
#define NS_ISCRIPTABLEUNICODECONVERTER_1_9_BRANCH_IID_STR "f7ed6618-5ff5-4f0b-bb83-48ce63eb289b"

#define NS_ISCRIPTABLEUNICODECONVERTER_1_9_BRANCH_IID \
  {0xf7ed6618, 0x5ff5, 0x4f0b, \
    { 0xbb, 0x83, 0x48, 0xce, 0x63, 0xeb, 0x28, 0x9b }}

class NS_NO_VTABLE NS_SCRIPTABLE nsIScriptableUnicodeConverter_1_9_BRANCH : public nsIScriptableUnicodeConverter {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_ISCRIPTABLEUNICODECONVERTER_1_9_BRANCH_IID)
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(nsIScriptableUnicodeConverter_1_9_BRANCH, NS_ISCRIPTABLEUNICODECONVERTER_1_9_BRANCH_IID)

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSISCRIPTABLEUNICODECONVERTER_1_9_BRANCH \
  NS_SCRIPTABLE NS_IMETHOD GetIsInternal(PRBool *aIsInternal); \
  NS_SCRIPTABLE NS_IMETHOD SetIsInternal(PRBool aIsInternal); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSISCRIPTABLEUNICODECONVERTER_1_9_BRANCH(_to) \
...
/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSISCRIPTABLEUNICODECONVERTER_1_9_BRANCH(_to) \
...
/* Header file */
class nsScriptableUnicodeConverter_1_9_BRANCH : public nsIScriptableUnicodeConverter_1_9_BRANCH
{
public:
  NS_DECL_ISUPPORTS
  NS_DECL_NSISCRIPTABLEUNICODECONVERTER_1_9_BRANCH

  nsScriptableUnicodeConverter_1_9_BRANCH();
...
/* Implementation file */
NS_IMPL_ISUPPORTS1(nsScriptableUnicodeConverter_1_9_BRANCH, nsIScriptableUnicodeConverter_1_9_BRANCH)

nsScriptableUnicodeConverter_1_9_BRANCH::nsScriptableUnicodeConverter_1_9_BRANCH()
{
  /* member initializers and constructor code */
}
...
/* attribute boolean isInternal; */
NS_IMETHODIMP nsScriptableUnicodeConverter_1_9_BRANCH::GetIsInternal(PRBool *aIsInternal)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
NS_IMETHODIMP nsScriptableUnicodeConverter_1_9_BRANCH::SetIsInternal(PRBool aIsInternal)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
