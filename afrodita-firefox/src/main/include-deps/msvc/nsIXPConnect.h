/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-192-xr-w32-bld/build/js/src/xpconnect/idl/nsIXPConnect.idl
 */
...
#define NS_IXPCONNECT_IID_STR "b76828b8-3ac5-469e-946d-3401c6a2104d"

#define NS_IXPCONNECT_IID \
  {0xb76828b8, 0x3ac5, 0x469e, \
    { 0x94, 0x6d, 0x34, 0x01, 0xc6, 0xa2, 0x10, 0x4d }}
...
class nsIXPConnect : public nsISupports {
 public: 
  ...
  /**
     ...
     */
  /* void wrapNativeToJSVal (in JSContextPtr aJSContext, in JSObjectPtr aScope, in nsISupports aCOMObj, in nsIIDPtr aIID, in boolean aAllowWrapper, out JSVal aVal, out nsIXPConnectJSObjectHolder aHolder); */
  NS_IMETHOD WrapNativeToJSVal(JSContext * aJSContext, JSObject * aScope, nsISupports *aCOMObj, const nsIID * aIID, PRBool aAllowWrapper, jsval *aVal NS_OUTPARAM, nsIXPConnectJSObjectHolder **aHolder NS_OUTPARAM) = 0;
  ...
  /**
     ...
     * @param aWrappedObj The object to wrap.
     */
  /* [noscript] JSVal getCOWForObject (in JSContextPtr aJSContext, in JSObjectPtr aParent, in JSObjectPtr aWrappedObj); */
  NS_IMETHOD GetCOWForObject(JSContext * aJSContext, JSObject * aParent, JSObject * aWrappedObj, jsval *_retval NS_OUTPARAM) = 0;
  ...
  /**
     ...
     */
  /* void GetXPCWrappedNativeJSClassInfo (out JSEqualityOp equality1, out JSEqualityOp equality2); */
  NS_IMETHOD GetXPCWrappedNativeJSClassInfo(JSEqualityOp *equality1 NS_OUTPARAM, JSEqualityOp *equality2 NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIXPCONNECT \
  ...
  NS_IMETHOD WrapNativeToJSVal(JSContext * aJSContext, JSObject * aScope, nsISupports *aCOMObj, const nsIID * aIID, PRBool aAllowWrapper, jsval *aVal NS_OUTPARAM, nsIXPConnectJSObjectHolder **aHolder NS_OUTPARAM); \
  ...
  NS_IMETHOD GetCOWForObject(JSContext * aJSContext, JSObject * aParent, JSObject * aWrappedObj, jsval *_retval NS_OUTPARAM); \
  ...
  NS_IMETHOD GetXPCWrappedNativeJSClassInfo(JSEqualityOp *equality1 NS_OUTPARAM, JSEqualityOp *equality2 NS_OUTPARAM); \
...
#define NS_FORWARD_NSIXPCONNECT(_to) \
  ...
  NS_IMETHOD WrapNativeToJSVal(JSContext * aJSContext, JSObject * aScope, nsISupports *aCOMObj, const nsIID * aIID, PRBool aAllowWrapper, jsval *aVal NS_OUTPARAM, nsIXPConnectJSObjectHolder **aHolder NS_OUTPARAM) { return _to WrapNativeToJSVal(aJSContext, aScope, aCOMObj, aIID, aAllowWrapper, aVal, aHolder); } \
  ...
  NS_IMETHOD GetCOWForObject(JSContext * aJSContext, JSObject * aParent, JSObject * aWrappedObj, jsval *_retval NS_OUTPARAM) { return _to GetCOWForObject(aJSContext, aParent, aWrappedObj, _retval); } \
  ...
  NS_IMETHOD GetXPCWrappedNativeJSClassInfo(JSEqualityOp *equality1 NS_OUTPARAM, JSEqualityOp *equality2 NS_OUTPARAM) { return _to GetXPCWrappedNativeJSClassInfo(equality1, equality2); } \
...
#define NS_FORWARD_SAFE_NSIXPCONNECT(_to) \
  ...
  NS_IMETHOD GetCOWForObject(JSContext * aJSContext, JSObject * aParent, JSObject * aWrappedObj, jsval *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCOWForObject(aJSContext, aParent, aWrappedObj, _retval); } \
  ...
  NS_IMETHOD GetXPCWrappedNativeJSClassInfo(JSEqualityOp *equality1 NS_OUTPARAM, JSEqualityOp *equality2 NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetXPCWrappedNativeJSClassInfo(equality1, equality2); } \
...
/* void wrapNativeToJSVal (in JSContextPtr aJSContext, in JSObjectPtr aScope, in nsISupports aCOMObj, in nsIIDPtr aIID, in boolean aAllowWrapper, out JSVal aVal, out nsIXPConnectJSObjectHolder aHolder); */
NS_IMETHODIMP nsXPConnect::WrapNativeToJSVal(JSContext * aJSContext, JSObject * aScope, nsISupports *aCOMObj, const nsIID * aIID, PRBool aAllowWrapper, jsval *aVal NS_OUTPARAM, nsIXPConnectJSObjectHolder **aHolder NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* [noscript] JSVal getCOWForObject (in JSContextPtr aJSContext, in JSObjectPtr aParent, in JSObjectPtr aWrappedObj); */
NS_IMETHODIMP nsXPConnect::GetCOWForObject(JSContext * aJSContext, JSObject * aParent, JSObject * aWrappedObj, jsval *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* void GetXPCWrappedNativeJSClassInfo (out JSEqualityOp equality1, out JSEqualityOp equality2); */
NS_IMETHODIMP nsXPConnect::GetXPCWrappedNativeJSClassInfo(JSEqualityOp *equality1 NS_OUTPARAM, JSEqualityOp *equality2 NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
