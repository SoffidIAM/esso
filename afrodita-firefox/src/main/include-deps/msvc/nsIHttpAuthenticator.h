/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-192-xr-w32-bld/build/netwerk/protocol/http/public/nsIHttpAuthenticator.idl
 */
...
/* starting interface:    nsIHttpAuthenticator_1_9_2 */
#define NS_IHTTPAUTHENTICATOR_1_9_2_IID_STR "923e7c35-6e0c-448c-81a1-39c93db597d9"

#define NS_IHTTPAUTHENTICATOR_1_9_2_IID \
  {0x923e7c35, 0x6e0c, 0x448c, \
    { 0x81, 0xa1, 0x39, 0xc9, 0x3d, 0xb5, 0x97, 0xd9 }}

class NS_NO_VTABLE NS_SCRIPTABLE nsIHttpAuthenticator_1_9_2 : public nsISupports {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_IHTTPAUTHENTICATOR_1_9_2_IID)
  ...
  /**
     ...
     */
  /* string generateCredentials_1_9_2 (in nsIHttpChannel aChannel, in string aChallenge, in boolean aProxyAuth, in wstring aDomain, in wstring aUser, in wstring aPassword, inout nsISupports aSessionState, inout nsISupports aContinuationState, out unsigned long aFlags); */
  NS_SCRIPTABLE NS_IMETHOD GenerateCredentials_1_9_2(nsIHttpChannel *aChannel, const char *aChallenge, PRBool aProxyAuth, const PRUnichar *aDomain, const PRUnichar *aUser, const PRUnichar *aPassword, nsISupports **aSessionState NS_INOUTPARAM, nsISupports **aContinuationState NS_INOUTPARAM, PRUint32 *aFlags NS_OUTPARAM, char **_retval NS_OUTPARAM) = 0;
...
/**
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(nsIHttpAuthenticator_1_9_2, NS_IHTTPAUTHENTICATOR_1_9_2_IID)

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIHTTPAUTHENTICATOR_1_9_2 \
  NS_SCRIPTABLE NS_IMETHOD GenerateCredentials_1_9_2(nsIHttpChannel *aChannel, const char *aChallenge, PRBool aProxyAuth, const PRUnichar *aDomain, const PRUnichar *aUser, const PRUnichar *aPassword, nsISupports **aSessionState NS_INOUTPARAM, nsISupports **aContinuationState NS_INOUTPARAM, PRUint32 *aFlags NS_OUTPARAM, char **_retval NS_OUTPARAM); \

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIHTTPAUTHENTICATOR_1_9_2(_to) \
  NS_SCRIPTABLE NS_IMETHOD GenerateCredentials_1_9_2(nsIHttpChannel *aChannel, const char *aChallenge, PRBool aProxyAuth, const PRUnichar *aDomain, const PRUnichar *aUser, const PRUnichar *aPassword, nsISupports **aSessionState NS_INOUTPARAM, nsISupports **aContinuationState NS_INOUTPARAM, PRUint32 *aFlags NS_OUTPARAM, char **_retval NS_OUTPARAM) { return _to GenerateCredentials_1_9_2(aChannel, aChallenge, aProxyAuth, aDomain, aUser, aPassword, aSessionState, aContinuationState, aFlags, _retval); } \

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIHTTPAUTHENTICATOR_1_9_2(_to) \
  NS_SCRIPTABLE NS_IMETHOD GenerateCredentials_1_9_2(nsIHttpChannel *aChannel, const char *aChallenge, PRBool aProxyAuth, const PRUnichar *aDomain, const PRUnichar *aUser, const PRUnichar *aPassword, nsISupports **aSessionState NS_INOUTPARAM, nsISupports **aContinuationState NS_INOUTPARAM, PRUint32 *aFlags NS_OUTPARAM, char **_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GenerateCredentials_1_9_2(aChannel, aChallenge, aProxyAuth, aDomain, aUser, aPassword, aSessionState, aContinuationState, aFlags, _retval); } \

#if 0
/* Use the code below as a template for the implementation class for this interface. */

/* Header file */
class nsHttpAuthenticator_1_9_2 : public nsIHttpAuthenticator_1_9_2
{
public:
  NS_DECL_ISUPPORTS
  NS_DECL_NSIHTTPAUTHENTICATOR_1_9_2

  nsHttpAuthenticator_1_9_2();
...
/* Implementation file */
NS_IMPL_ISUPPORTS1(nsHttpAuthenticator_1_9_2, nsIHttpAuthenticator_1_9_2)

nsHttpAuthenticator_1_9_2::nsHttpAuthenticator_1_9_2()
{
  /* member initializers and constructor code */
}
...
/* string generateCredentials_1_9_2 (in nsIHttpChannel aChannel, in string aChallenge, in boolean aProxyAuth, in wstring aDomain, in wstring aUser, in wstring aPassword, inout nsISupports aSessionState, inout nsISupports aContinuationState, out unsigned long aFlags); */
NS_IMETHODIMP nsHttpAuthenticator_1_9_2::GenerateCredentials_1_9_2(nsIHttpChannel *aChannel, const char *aChallenge, PRBool aProxyAuth, const PRUnichar *aDomain, const PRUnichar *aUser, const PRUnichar *aPassword, nsISupports **aSessionState NS_INOUTPARAM, nsISupports **aContinuationState NS_INOUTPARAM, PRUint32 *aFlags NS_OUTPARAM, char **_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
