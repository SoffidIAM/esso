/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-192-xr-w32-bld/build/netwerk/protocol/http/public/nsIHttpProtocolHandler.idl
 */
...
#define NS_IHTTPPROTOCOLHANDLER_IID_STR "415d4087-79d3-40fe-b194-0ada8471f895"

#define NS_IHTTPPROTOCOLHANDLER_IID \
  {0x415d4087, 0x79d3, 0x40fe, \
    { 0xb1, 0x94, 0x0a, 0xda, 0x84, 0x71, 0xf8, 0x95 }}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIHttpProtocolHandler : public nsIProxiedProtocolHandler {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetDeviceType(nsACString & aDeviceType) = 0;
...
#define NS_DECL_NSIHTTPPROTOCOLHANDLER \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetDeviceType(nsACString & aDeviceType); 
...
#define NS_FORWARD_NSIHTTPPROTOCOLHANDLER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetDeviceType(nsACString & aDeviceType) { return _to GetDeviceType(aDeviceType); } 
...
#define NS_FORWARD_SAFE_NSIHTTPPROTOCOLHANDLER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetDeviceType(nsACString & aDeviceType) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetDeviceType(aDeviceType); } 
...
/* readonly attribute ACString deviceType; */
NS_IMETHODIMP nsHttpProtocolHandler::GetDeviceType(nsACString & aDeviceType)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
