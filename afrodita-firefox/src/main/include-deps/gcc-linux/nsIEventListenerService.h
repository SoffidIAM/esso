/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM nsIEventListenerService.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIEventListenerService : public nsISupports {
 public: 
   ...
   */
  /* void getListenerInfoFor (in nsIDOMEventTarget aEventTarget, out unsigned long aCount, [array, retval, size_is (aCount)] out nsIEventListenerInfo aOutArray); */
  ...
  */
  /* void getEventTargetChainFor (in nsIDOMEventTarget aEventTarget, out unsigned long aCount, [array, retval, size_is (aCount)] out nsIDOMEventTarget aOutArray); */
