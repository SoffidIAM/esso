...
#define NS_IEXTENSIONMANAGER_IID_STR "494e8302-8689-4a8a-a08d-0da17c649c7d"

#define NS_IEXTENSIONMANAGER_IID \
  {0x494e8302, 0x8689, 0x4a8a, \
    { 0xa0, 0x8d, 0x0d, 0xa1, 0x7c, 0x64, 0x9c, 0x7d }}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIExtensionManager : public nsISupports {
 public: 
   ...
   */
  enum { UPDATE_WHEN_USER_REQUESTED = 1U };

  /**
   * The update check is being performed after a new version of the application
   * has been detected.
   */
  enum { UPDATE_WHEN_NEW_APP_DETECTED = 2U };

  /**
   * The update check is being performed after a new version of the application
   * has been installed.
   */
  enum { UPDATE_WHEN_NEW_APP_INSTALLED = 3U };
  ...
  NS_SCRIPTABLE NS_IMETHOD Update(nsIUpdateItem **items, PRUint32 itemCount, PRUint32 updateCheckType, nsIAddonUpdateCheckListener *listener, PRUint32 updateType, const nsAString & appVersion, const nsAString & platformVersion) = 0;
   ...
   *          install location.
   */
  /* void getItemList (in unsigned long type, out unsigned long itemCount, [array, retval, size_is (itemCount)] out nsIUpdateItem items); */
   ...
   */
  /* void getIncompatibleItemList (in AString appVersion, in AString platformVersion, in unsigned long type, in boolean includeDisabled, out unsigned long itemCount, [array, retval, size_is (itemCount)] out nsIUpdateItem items); */
  NS_SCRIPTABLE NS_IMETHOD GetIncompatibleItemList(const nsAString & appVersion, const nsAString & platformVersion, PRUint32 type, PRBool includeDisabled, PRUint32 *itemCount NS_OUTPARAM, nsIUpdateItem ***items NS_OUTPARAM) = 0;
   ...
   */
  /* void getDependentItemListForID (in AString id, in boolean includeDisabled, out unsigned long itemCount, [array, retval, size_is (itemCount)] out nsIUpdateItem items); */
   ...
   */
  /* void updateAndGetNewBlocklistedItems (out unsigned long itemCount, [array, retval, size_is (itemCount)] out nsIUpdateItem items); */
...
#define NS_DECL_NSIEXTENSIONMANAGER \
  ...
  NS_SCRIPTABLE NS_IMETHOD Update(nsIUpdateItem **items, PRUint32 itemCount, PRUint32 updateCheckType, nsIAddonUpdateCheckListener *listener, PRUint32 updateType, const nsAString & appVersion, const nsAString & platformVersion); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIncompatibleItemList(const nsAString & appVersion, const nsAString & platformVersion, PRUint32 type, PRBool includeDisabled, PRUint32 *itemCount NS_OUTPARAM, nsIUpdateItem ***items NS_OUTPARAM); \
...
#define NS_FORWARD_NSIEXTENSIONMANAGER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Update(nsIUpdateItem **items, PRUint32 itemCount, PRUint32 updateCheckType, nsIAddonUpdateCheckListener *listener, PRUint32 updateType, const nsAString & appVersion, const nsAString & platformVersion) { return _to Update(items, itemCount, updateCheckType, listener, updateType, appVersion, platformVersion); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIncompatibleItemList(const nsAString & appVersion, const nsAString & platformVersion, PRUint32 type, PRBool includeDisabled, PRUint32 *itemCount NS_OUTPARAM, nsIUpdateItem ***items NS_OUTPARAM) { return _to GetIncompatibleItemList(appVersion, platformVersion, type, includeDisabled, itemCount, items); } \
...
#define NS_FORWARD_SAFE_NSIEXTENSIONMANAGER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Update(nsIUpdateItem **items, PRUint32 itemCount, PRUint32 updateCheckType, nsIAddonUpdateCheckListener *listener, PRUint32 updateType, const nsAString & appVersion, const nsAString & platformVersion) { return !_to ? NS_ERROR_NULL_POINTER : _to->Update(items, itemCount, updateCheckType, listener, updateType, appVersion, platformVersion); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIncompatibleItemList(const nsAString & appVersion, const nsAString & platformVersion, PRUint32 type, PRBool includeDisabled, PRUint32 *itemCount NS_OUTPARAM, nsIUpdateItem ***items NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIncompatibleItemList(appVersion, platformVersion, type, includeDisabled, itemCount, items); } \
...
/* boolean start (); */
NS_IMETHODIMP nsExtensionManager::Start(PRBool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* void update ([array, size_is (itemCount)] in nsIUpdateItem items, in unsigned long itemCount, in unsigned long updateCheckType, in nsIAddonUpdateCheckListener listener, [optional] in unsigned long updateType, [optional] in AString appVersion, [optional] in AString platformVersion); */
NS_IMETHODIMP nsExtensionManager::Update(nsIUpdateItem **items, PRUint32 itemCount, PRUint32 updateCheckType, nsIAddonUpdateCheckListener *listener, PRUint32 updateType, const nsAString & appVersion, const nsAString & platformVersion)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* void getIncompatibleItemList (in AString appVersion, in AString platformVersion, in unsigned long type, in boolean includeDisabled, out unsigned long itemCount, [array, retval, size_is (itemCount)] out nsIUpdateItem items); */
NS_IMETHODIMP nsExtensionManager::GetIncompatibleItemList(const nsAString & appVersion, const nsAString & platformVersion, PRUint32 type, PRBool includeDisabled, PRUint32 *itemCount NS_OUTPARAM, nsIUpdateItem ***items NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
