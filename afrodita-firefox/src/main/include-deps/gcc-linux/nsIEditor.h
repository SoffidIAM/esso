...
/* starting interface:    nsIEditor_MOZILLA_1_9_2_BRANCH */
#define NS_IEDITOR_MOZILLA_1_9_2_BRANCH_IID_STR "a9ddee78-f5d2-43f1-9d91-d2124ba40d81"

#define NS_IEDITOR_MOZILLA_1_9_2_BRANCH_IID \
  {0xa9ddee78, 0xf5d2, 0x43f1, \
    { 0x9d, 0x91, 0xd2, 0x12, 0x4b, 0xa4, 0x0d, 0x81 }}

class NS_NO_VTABLE nsIEditor_MOZILLA_1_9_2_BRANCH : public nsISupports {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_IEDITOR_MOZILLA_1_9_2_BRANCH_IID)
  ...
  NS_IMETHOD GetLastKeypressEventTrusted(PRBool *aLastKeypressEventTrusted) = 0;

};

  NS_DEFINE_STATIC_IID_ACCESSOR(nsIEditor_MOZILLA_1_9_2_BRANCH, NS_IEDITOR_MOZILLA_1_9_2_BRANCH_IID)

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIEDITOR_MOZILLA_1_9_2_BRANCH \
  NS_IMETHOD GetLastKeypressEventTrusted(PRBool *aLastKeypressEventTrusted); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIEDITOR_MOZILLA_1_9_2_BRANCH(_to) \
  NS_IMETHOD GetLastKeypressEventTrusted(PRBool *aLastKeypressEventTrusted) { return _to GetLastKeypressEventTrusted(aLastKeypressEventTrusted); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIEDITOR_MOZILLA_1_9_2_BRANCH(_to) \
  NS_IMETHOD GetLastKeypressEventTrusted(PRBool *aLastKeypressEventTrusted) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetLastKeypressEventTrusted(aLastKeypressEventTrusted); } 

#if 0
/* Use the code below as a template for the implementation class for this interface. */

/* Header file */
class nsEditor_MOZILLA_1_9_2_BRANCH : public nsIEditor_MOZILLA_1_9_2_BRANCH
{
public:
  NS_DECL_ISUPPORTS
  NS_DECL_NSIEDITOR_MOZILLA_1_9_2_BRANCH

  nsEditor_MOZILLA_1_9_2_BRANCH();
...
/* Implementation file */
NS_IMPL_ISUPPORTS1(nsEditor_MOZILLA_1_9_2_BRANCH, nsIEditor_MOZILLA_1_9_2_BRANCH)

nsEditor_MOZILLA_1_9_2_BRANCH::nsEditor_MOZILLA_1_9_2_BRANCH()
{
  /* member initializers and constructor code */
}
...
/* readonly attribute boolean lastKeypressEventTrusted; */
NS_IMETHODIMP nsEditor_MOZILLA_1_9_2_BRANCH::GetLastKeypressEventTrusted(PRBool *aLastKeypressEventTrusted)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
