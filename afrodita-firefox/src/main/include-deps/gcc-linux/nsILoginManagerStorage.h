/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM nsILoginManagerStorage.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsILoginManagerStorage : public nsISupports {
 public: 
  ...
  /**
    ...
    *       (|logins| is an array).
    */
  /* void getAllEncryptedLogins (out unsigned long count, [array, retval, size_is (count)] out nsILoginInfo logins); */
