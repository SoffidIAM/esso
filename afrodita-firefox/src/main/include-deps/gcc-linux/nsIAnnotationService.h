...
class NS_NO_VTABLE NS_SCRIPTABLE nsIAnnotationService : public nsISupports {
 public: 
  ...
  /**
     ...
     */
  /* void getPagesWithAnnotation (in AUTF8String name, out unsigned long resultCount, [array, retval, size_is (resultCount)] out nsIURI results); */
  ...
  /* void getItemsWithAnnotation (in AUTF8String name, out unsigned long resultCount, [array, retval, size_is (resultCount)] out long long results); */
  ...
  /**
     ...
     */
  /* void getPageAnnotationNames (in nsIURI aURI, out unsigned long count, [array, retval, size_is (count)] out nsIVariant result); */
  NS_SCRIPTABLE NS_IMETHOD GetPageAnnotationNames(nsIURI *aURI, PRUint32 *count NS_OUTPARAM, nsIVariant ***result NS_OUTPARAM) = 0;

  /* void getItemAnnotationNames (in long long aItemId, out unsigned long count, [array, retval, size_is (count)] out nsIVariant result); */
