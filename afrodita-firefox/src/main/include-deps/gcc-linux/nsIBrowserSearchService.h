/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM nsIBrowserSearchService.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIBrowserSearchService : public nsISupports {
 public: 
   ...
   */
  /* void getEngines (out unsigned long engineCount, [array, retval, size_is (engineCount)] out nsISearchEngine engines); */
   ...
   * @returns an array of nsISearchEngine objects.
   */
  /* void getVisibleEngines (out unsigned long engineCount, [array, retval, size_is (engineCount)] out nsISearchEngine engines); */
   ...
   * @returns an array of nsISearchEngine objects.
   */
  /* void getDefaultEngines (out unsigned long engineCount, [array, retval, size_is (engineCount)] out nsISearchEngine engines); */
