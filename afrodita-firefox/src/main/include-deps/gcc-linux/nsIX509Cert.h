...
class NS_NO_VTABLE NS_SCRIPTABLE nsIX509Cert : public nsISupports {
 public: 
   ...
   */
  /* void getEmailAddresses (out unsigned long length, [array, retval, size_is (length)] out wstring addresses); */
   ...
   */
  /* void getRawDER (out unsigned long length, [array, retval, size_is (length)] out octet data); */
