...
#define NS_IACCESSIBLETABLE_IID_STR "035c0c0e-41e3-4985-8ad9-d9f14cdc667a"

#define NS_IACCESSIBLETABLE_IID \
  {0x035c0c0e, 0x41e3, 0x4985, \
    { 0x8a, 0xd9, 0xd9, 0xf1, 0x4c, 0xdc, 0x66, 0x7a }}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIAccessibleTable : public nsISupports {
 public: 
   ...
   */
  /* void getSelectedCellIndices (out unsigned long cellsArraySize, [array, retval, size_is (cellsArraySize)] out long cellsArray); */
   ...
   */
  /* void getSelectedColumnIndices (out unsigned long columnsArraySize, [array, retval, size_is (columnsArraySize)] out long columnsArray); */
   ...
   */
  /* void getSelectedRowIndices (out unsigned long rowsArraySize, [array, retval, size_is (rowsArraySize)] out long rowsArray); */
