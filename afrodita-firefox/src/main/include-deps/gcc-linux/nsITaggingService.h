/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM nsITaggingService.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsITaggingService : public nsISupports {
 public: 
   ...
   */
  /* void getTagsForURI (in nsIURI aURI, out unsigned long length, [array, retval, size_is (length)] out wstring aTags); */
