/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /builds/slave/rel-cen-xr-lnx-bld/build/dom/interfaces/html/nsIDOMHTMLInputElement.idl
 */

#ifndef __gen_nsIDOMHTMLInputElement4_h__
#define __gen_nsIDOMHTMLInputElement4_h__
...
#define NS_IDOMHTMLINPUTELEMENT4_IID_STR "0805059d-f18f-4095-ae6b-0bf6df80b7b8"

#define NS_IDOMHTMLINPUTELEMENT4_IID \
...
/**
  ...
  */
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMHTMLInputElement4 : public nsIDOMHTMLElement {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD CheckValidity(PRBool *_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD MozGetFileNameArray(PRUint32 *aLength, PRUnichar ***aFileNames ) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD MozIsTextField(PRBool aExcludePassword, PRBool *_retval ) = 0;
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(nsIDOMHTMLInputElement4, NS_IDOMHTMLINPUTELEMENT4_IID)

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIDOMHTMLINPUTELEMENT4 \
  ...
  NS_SCRIPTABLE NS_IMETHOD CheckValidity(PRBool *_retval); \
  ...
  NS_SCRIPTABLE NS_IMETHOD MozGetFileNameArray(PRUint32 *aLength, PRUnichar ***aFileNames); \
  NS_SCRIPTABLE NS_IMETHOD MozSetFileNameArray(const PRUnichar **aFileNames, PRUint32 aLength); \
  NS_SCRIPTABLE NS_IMETHOD MozIsTextField(PRBool aExcludePassword, PRBool *_retval); \
...
#define NS_FORWARD_NSIDOMHTMLINPUTELEMENT4(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD CheckValidity(PRBool *_retval ) { return _to CheckValidity(_retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD MozGetFileNameArray(PRUint32 *aLength , PRUnichar ***aFileNames ) { return _to MozGetFileNameArray(aLength, aFileNames); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD MozIsTextField(PRBool aExcludePassword, PRBool *_retval ) { return _to MozIsTextField(aExcludePassword, _retval); } \
...
#define NS_FORWARD_SAFE_NSIDOMHTMLINPUTELEMENT4(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD CheckValidity(PRBool *_retval ) { return !_to ? NS_ERROR_NULL_POINTER : _to->CheckValidity(_retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD MozGetFileNameArray(PRUint32 *aLength , PRUnichar ***aFileNames ) { return !_to ? NS_ERROR_NULL_POINTER : _to->MozGetFileNameArray(aLength, aFileNames); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD MozIsTextField(PRBool aExcludePassword, PRBool *_retval ) { return !_to ? NS_ERROR_NULL_POINTER : _to->MozIsTextField(aExcludePassword, _retval); } \
...
/* Header file */
class nsDOMHTMLInputElement4 : public nsIDOMHTMLInputElement4
{
public:
  NS_DECL_ISUPPORTS
  NS_DECL_NSIDOMHTMLINPUTELEMENT4

  nsDOMHTMLInputElement4();
...
/* Implementation file */
NS_IMPL_ISUPPORTS1(nsDOMHTMLInputElement4, nsIDOMHTMLInputElement4)
