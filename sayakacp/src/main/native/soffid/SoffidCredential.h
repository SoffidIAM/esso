#ifndef SOFFIDOCREDENTIAL_H_
#define SOFFIDCREDENTIAL_H_
...
class SoffidCredential: public IConnectableCredentialProviderCredential {
public:
...
private:
    ...
    CREDENTIAL_PROVIDER_FIELD_STATE 	  m_cpfs [SOF_NUM_FIELDS];
    CREDENTIAL_PROVIDER_FIELD_INTERACTIVE_STATE m_cpfis[SOF_NUM_FIELDS];
    CREDENTIAL_PROVIDER_FIELD_DESCRIPTOR  m_rgCredProvFieldDescriptors[SOF_NUM_FIELDS];
    wchar_t*                              m_rgFieldStrings[SOF_NUM_FIELDS];
	long m_nRefCount;
	Log m_log;
	void displayMessage();
	void hideMessage();
	IQueryContinueWithStatus* m_pQueryContinueWithStatus = NULL;
