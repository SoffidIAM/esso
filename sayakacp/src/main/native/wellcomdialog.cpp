...
//////////////////////////////////////////////////////////
static INT_PTR __stdcall wellcomeDialogProc (HWND hwndDlg, // handle to dialog box
		UINT uMsg,	// message
		...
		)
{
	switch (uMsg)
	{
		case WM_INITDIALOG:
		{
			SendMessage(hwndDlg, WM_SYSCOMMAND, SC_HOTKEY, (LPARAM) hwndDlg);
			SendMessage(hwndDlg, WM_SYSCOMMAND, SC_RESTORE, (LPARAM) hwndDlg);
...
{
//	DialogBox(hSayakaInstance, MAKEINTRESOURCE (IDD_LOGOUT),
//			NULL, wellcomeDialogProc);
}
