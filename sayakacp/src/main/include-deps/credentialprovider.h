...
#define __RPC__in_ecount_full_opt(a)
...
#undef __RPC__in
#undef __RPC__in_opt
#undef __RPC__deref_out_opt_string
#undef __RPC__deref_out_ecount_full_opt
#undef __out_ecount_opt
#undef __RPC__out_ecount_part
#undef __out_ecount_part
#undef __deref_out_range
#undef __RPC__inout
#undef __RPC__in_opt
#undef __RPC__inout_opt
#undef __RPC__in_string
#undef __RPC__deref_out_opt
#undef __RPC__in_opt_string
#undef __RPC__in_ecount_full
#undef __RPC__out_ecount_full_string
#undef __in_ecount
#undef DEFINE_ENUM_FLAG_OPERATORS
#undef __deref_outundefine__reserved
#undef __out_awcount
#undef __RPC__in_ecount_full_opt
#undef __RPC__out_ecount_full
#undef __RPC_unique_pointer
#undef __RPC__in_range
