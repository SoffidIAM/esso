...
HRESULT __stdcall CExplorerFactory::CreateInstance(IUnknown* pUnknownOuter,
    ...
    //
    CExplorerObj* pObject = new CExplorerObj ;
    if (pObject == NULL)
        {
...
HRESULT __stdcall CExplorerFactory::LockServer(BOOL bLock)
    {
    return E_NOTIMPL;
    }


HRESULT __stdcall CExplorerFactory::QueryInterface(REFIID riid, void **ppObj)
{
...
ULONG __stdcall CExplorerFactory::AddRef()
{
	return InterlockedIncrement(&m_nRefCount) ;
}


ULONG __stdcall CExplorerFactory::Release()
{
	long nRefCount=0;
