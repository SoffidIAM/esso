...
public:
	...
	bool getSavedCredentials(CertificateHandler *cert, std::wstring &szUser,std::wstring &szPassword);
	bool saveCredentials(CertificateHandler *cert, std::wstring  &szUser, std::wstring &szPassword) ;
