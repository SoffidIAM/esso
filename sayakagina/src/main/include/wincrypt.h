...
#ifdef UNICODE
#define EXPAND_WNCRYPT_AW(x) x##W
#else
#define EXPAND_WNCRYPT_AW(x) x##A
#endif
...
#define CREDENTIAL_OID_PASSWORD_CREDENTIALS \
 EXPAND_WNCRYPT_AW(CREDENTIAL_OID_PASSWORD_CREDENTIALS_)
...
#define CRYPT_PASSWORD_CREDENTIALS EXPAND_WNCRYPT_AW(CRYPT_PASSWORD_CREDENTIALS)
#define PCRYPT_PASSWORD_CREDENTIALS EXPAND_WNCRYPT_AW(PCRYPT_PASSWORD_CREDENTIALS)
...
static const WCHAR MS_DEF_PROV_W[] =             { 'M','i','c','r','o','s','o','f','t',' ',
	...
	'P','r','o','v','i','d','e','r',' ','v','1','.','0',0 };
#endif
#define MS_DEF_PROV                              EXPAND_WNCRYPT_AW(MS_DEF_PROV_)
...
static const WCHAR MS_ENHANCED_PROV_W[] =        { 'M','i','c','r','o','s','o','f','t',' ',
	...
	'P','r','o','v','i','d','e','r',' ','v','1','.','0',0 };
#endif
#define MS_ENHANCED_PROV                         EXPAND_WNCRYPT_AW(MS_ENHANCED_PROV_)
...
static const WCHAR MS_STRONG_PROV_W[] =          { 'M','i','c','r','o','s','o','f','t',' ',
	...
	'P','r','o','v','i','d','e','r',0 };
#endif
#define MS_STRONG_PROV                           EXPAND_WNCRYPT_AW(MS_STRONG_PROV_)
...
static const WCHAR MS_DEF_RSA_SIG_PROV_W[] =     { 'M','i','c','r','o','s','o','f','t',' ',
	...
	'C','r','y','p','t','o','g','r','a','p','h','i','c',' ','P','r','o','v','i','d','e','r',0 };
#endif
#define MS_DEF_RSA_SIG_PROV                      EXPAND_WNCRYPT_AW(MS_DEF_RSA_SIG_PROV_)
...
static const WCHAR MS_DEF_RSA_SCHANNEL_PROV_W[] = { 'M','i','c','r','o','s','o','f','t',' ',
	...
	'C','r','y','p','t','o','g','r','a','p','h','i','c',' ','P','r','o','v','i','d','e','r',0 };
#endif
#define MS_DEF_RSA_SCHANNEL_PROV                 EXPAND_WNCRYPT_AW(MS_DEF_RSA_SCHANNEL_PROV_)
...
static const WCHAR MS_DEF_DSS_PROV_W[] =         { 'M','i','c','r','o','s','o','f','t',' ',
	...
	'C','r','y','p','t','o','g','r','a','p','h','i','c',' ','P','r','o','v','i','d','e','r',0 };
#endif
#define MS_DEF_DSS_PROV                          EXPAND_WNCRYPT_AW(MS_DEF_DSS_PROV_)
...
static const WCHAR MS_DEF_DSS_DH_PROV_W[] =      { 'M','i','c','r','o','s','o','f','t',' ',
	...
	'C','r','y','p','t','o','g','r','a','p','h','i','c',' ','P','r','o','v','i','d','e','r',0 };
#endif
#define MS_DEF_DSS_DH_PROV                       EXPAND_WNCRYPT_AW(MS_DEF_DSS_DH_PROV_)
...
static const WCHAR MS_ENH_DSS_DH_PROV_W[] =      { 'M','i','c','r','o','s','o','f','t',' ',
	...
	'C','r','y','p','t','o','g','r','a','p','h','i','c',' ','P','r','o','v','i','d','e','r',0 };
#endif
#define MS_ENH_DSS_DH_PROV                       EXPAND_WNCRYPT_AW(MS_ENH_DSS_DH_PROV_)
...
static const WCHAR MS_DEF_DH_SCHANNEL_PROV_W[] = { 'M','i','c','r','o','s','o','f','t',' ',
	...
	'C','r','y','p','t','o','g','r','a','p','h','i','c',' ','P','r','o','v','i','d','e','r',0 };
#endif
#define MS_DEF_DH_SCHANNEL_PROV                  EXPAND_WNCRYPT_AW(MS_DEF_DH_SCHANNEL_PROV_)
...
static const WCHAR MS_SCARD_PROV_W[] =           { 'M','i','c','r','o','s','o','f','t',' ',
	...
	'C','r','y','p','t','o','g','r','a','p','h','i','c',' ','P','r','o','v','i','d','e','r',0 };
#endif
#define MS_SCARD_PROV                            EXPAND_WNCRYPT_AW(MS_SCARD_PROV_)
...
static const WCHAR MS_ENH_RSA_AES_PROV_W[] =           { 'M','i','c','r','o','s','o','f','t',' ',
	...
	'C','r','y','p','t','o','g','r','a','p','h','i','c',' ','P','r','o','v','i','d','e','r',0 };
#endif
#define MS_ENH_RSA_AES_PROV                            EXPAND_WNCRYPT_AW(MS_ENH_RSA_AES_PROV_)
...
#define               CryptAcquireContext EXPAND_WNCRYPT_AW(CryptAcquireContext)
...
#define               CryptEnumProviders EXPAND_WNCRYPT_AW(CryptEnumProviders)
...
#define               CryptEnumProviderTypes EXPAND_WNCRYPT_AW(CryptEnumProviderTypes)
...
#define               CryptGetDefaultProvider EXPAND_WNCRYPT_AW(CryptGetDefaultProvider)
...
#define               CryptSetProvider EXPAND_WNCRYPT_AW(CryptSetProvider)
...
#define               CryptSetProviderEx EXPAND_WNCRYPT_AW(CryptSetProviderEx)
...
#define               CryptSignHash EXPAND_WNCRYPT_AW(CryptSignHash)
...
#define               CryptVerifySignature EXPAND_WNCRYPT_AW(CryptVerifySignature)
...
#define CryptBinaryToString EXPAND_WNCRYPT_AW(CryptBinaryToString)
...
BOOL WINAPI CryptStringToBinaryW(LPCWSTR pszString,
 DWORD cchString, DWORD dwFlags, BYTE *pbBinary, DWORD *pcbBinary,
 DWORD *pdwSkip, DWORD *pdwFlags);
#define CryptStringToBinary EXPAND_WNCRYPT_AW(CryptStringToBinary)
...
#define CertOpenSystemStore EXPAND_WNCRYPT_AW(CertOpenSystemStore)
...
#define CertGetNameString EXPAND_WNCRYPT_AW(CertGetNameString)
...
#define CertRDNValueToStr EXPAND_WNCRYPT_AW(CertRDNValueToStr)
...
#define CertNameToStr EXPAND_WNCRYPT_AW(CertNameToStr)
...
BOOL WINAPI CertStrToNameW(DWORD dwCertEncodingType, LPCWSTR pszX500,
 DWORD dwStrType, void *pvReserved, BYTE *pbEncoded, DWORD *pcbEncoded,
 LPCWSTR *ppszError);
#define CertStrToName EXPAND_WNCRYPT_AW(CertStrToName)
...
BOOL WINAPI CryptRetrieveObjectByUrlW(LPCWSTR pszURL, LPCSTR pszObjectOid,
 ...
 HCRYPTASYNC hAsyncRetrieve, PCRYPT_CREDENTIALS pCredentials, LPVOID pvVerify,
 PCRYPT_RETRIEVE_AUX_INFO pAuxInfo);
#define CryptRetrieveObjectByUrl EXPAND_WNCRYPT_AW(CryptRetrieveObjectByUrl)
