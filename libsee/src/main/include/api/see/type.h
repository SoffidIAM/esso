...
#ifdef __GNUC__/* !HAVE_INTTYPES_H */
# include <inttypes.h>
...
#if 1/*HAVE_CONSTANT_HEX_FLOAT*/ && 0/*!HAVE_CONSTANT_NAN_DIV*/ && 1/*HAVE_CONSTANT_INF_DIV*/
...
#ifndef __GNUC__
	#undef SEE_ALLOCA
	#define SEE_ALLOCA(i,t,n)  (t *)((n) ? _alloca((n) * sizeof (t)) : 0)
#endif
